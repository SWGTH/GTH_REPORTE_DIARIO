...
namespace ReportePeriodo.Datos
{
    ...
    public class ModeloDatosSQL
    {
        ...
        public ModeloDatosSQL(string cadenaConexion)
        {
            Configurar(cadenaConexion);
        }
        ...
        private void Configurar(string conexion)
        {
            try
            {
        ...
        public void CrearComando(string sentenciaSQL, tipoComandoSQL tipo)
        {
            this.Comando = new SqlCommand();
            this.Comando.Connection = Conexion;
            this.Comando.CommandTimeout = 0;
            if (tipo == tipoComandoSQL.query)
            {
