...
namespace ReportePeriodo.Presentador
{
    public class Presenter
    {
        ...
        public List<Hoja1> ReporteHoja1(Rancho rancho, DateTime fechaInicio, DateTime fechaFin, out List<decimal?> listaDEC, ref string mensaje)
        {
            ...
            //_model.DatoMejorPromedioUltimos10Años(promedioAñoAnt, fechaInicio.AddYears(-1), fechaFin.AddYears(-1), ref mensaje);
        ...
        {
            return  _model.MejorPromedio(fechaInicio.AddMonths(-1), fechaFin.AddMonths(-1), ref mensaje);
        }
