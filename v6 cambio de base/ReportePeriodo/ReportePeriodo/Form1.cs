    ...
    public partial class Form1 : Form, IView
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (_origen)
            {
                ...
                _presentador.ValoresConsistentes(_centro, _rancho, fechaFin);
                Reporte(_centro, _rancho, fechaInicio, fechaFin);
                Close();
            }
        }
        ...
        private void Configurar()
        {
            ...
            _centro = _presentador.GetCentro();
        ...
        public void Reporte(CentroTyp centro, Rancho rancho, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            _presentador.CargarDatosTeoricos(_centro, fechaInicio, fechaFin, ref _mensaje);
            _presentador.CargarPromediosDatosAlimentacion(_centro, fechaInicio, fechaFin, ref _mensaje);
            _presentador.CargarPrecioLeche(_centro, rancho, fechaInicio, fechaFin, ref _mensaje);
            ...
            #region hoja2
            List<Hoja2> reporteHoja2 = _presentador.ReporteHoja2(_centro, rancho, fechaInicio, fechaFin, ref _mensaje);
            ...
            try 
            {
                ...
                string cadenaPrecioLeche = "VENTA (PRECIO DE LA LECHE Actual: @actual / Año Anterior: @anterior)";
                cadenaPrecioLeche = cadenaPrecioLeche.Replace("@actual", _presentador.PrecioLeche.ToString("C3")).Replace("@anterior", _presentador.PrecioLecheAñoAnt.ToString("C3"));
                ...
                parameters[7] = new ReportParameter("PRECIO_LECHE", cadenaPrecioLeche, true);
