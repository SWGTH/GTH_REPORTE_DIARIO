...
using System.Data;
using gth = LibreriaGTH.Consumos.Modelo;
...
namespace ReportePeriodo.Modelo
{
    ...
    {
        string conexionDBConsumo = @"data source = localhost\SIO; initial catalog = DBCONSUMO; user id = sa; password = CiaPrest_";
        string conexionAccess;
        string conexionSQL;
        string conexionFDB;
        string conexionSIE;

        gth.ConsumoModel consumoModel;

        List<gthEntity.IndicadorReporteTeorico> indicadorProduccion;
        List<gthEntity.IndicadorReporteTeorico> indicadorSecas;
        List<gthEntity.IndicadorReporteTeorico> indicadorReto;
        List<gthEntity.IndicadorReporteTeorico> indicadorCrecimiento;
        List<gthEntity.IndicadorReporteTeorico> indicadorDesarrollo;
        List<gthEntity.IndicadorReporteTeorico> indicadorVaquillas;

        gthEntity.IndicadorReportePeriodoTyp promedioProduccion;
        gthEntity.IndicadorReportePeriodoTyp promedioSecas;
        gthEntity.IndicadorReportePeriodoTyp promedioReto;
        gthEntity.IndicadorReportePeriodoTyp promedioJaulas;
        gthEntity.IndicadorReportePeriodoTyp promedioCrecimiento;
        gthEntity.IndicadorReportePeriodoTyp promedioDesarrollo;
        gthEntity.IndicadorReportePeriodoTyp promedioVaquillas;

        gthEntity.IndicadorReportePeriodoTyp promedioAntProduccion;
        gthEntity.IndicadorReportePeriodoTyp promedioAntSecas;
        gthEntity.IndicadorReportePeriodoTyp promedioAntReto;
        gthEntity.IndicadorReportePeriodoTyp promedioAntJaulas;
        gthEntity.IndicadorReportePeriodoTyp promedioAntCrecimiento;
        gthEntity.IndicadorReportePeriodoTyp promedioAntDesarrollo;
        gthEntity.IndicadorReportePeriodoTyp promedioAntVaquillas;

        decimal precioLeche;
        decimal precioLecheAñoAnt;

        gthEntity.EtapaTyp etapaProduccion = new gthEntity.EtapaTyp() { Id = 1, Clave = "10", Nombre = "Produccion" };
        gthEntity.EtapaTyp etapaSecas = new gthEntity.EtapaTyp() { Id = 2, Clave = "21", Nombre = "Secas" };
        gthEntity.EtapaTyp etapaReto = new gthEntity.EtapaTyp() { Id = 3, Clave = "22", Nombre = "Reto" };
        gthEntity.EtapaTyp etapaJaulas = new gthEntity.EtapaTyp() { Id = 4, Clave = "31", Nombre = "Jaulas" };
        gthEntity.EtapaTyp etapaCrecimiento = new gthEntity.EtapaTyp() { Id = 5, Clave = "32", Nombre = "Crecimiento" };
        gthEntity.EtapaTyp etapaDesarrollo = new gthEntity.EtapaTyp() { Id = 6, Clave = "33", Nombre = "Desarrollo" };
        gthEntity.EtapaTyp etapaVaquillas = new gthEntity.EtapaTyp() { Id = 7, Clave = "34", Nombre = "Vaquillas Preñadas" };
        ...
        public Model(string conexionAccess, string conexionSQL)
        {
            ...
            this.consumoModel = new gth.ConsumoModel(conexionDBConsumo);

            indicadorProduccion = new List<gthEntity.IndicadorReporteTeorico>();
            indicadorSecas = new List<gthEntity.IndicadorReporteTeorico>();
            indicadorReto = new List<gthEntity.IndicadorReporteTeorico>();
            indicadorCrecimiento = new List<gthEntity.IndicadorReporteTeorico>();
            indicadorDesarrollo = new List<gthEntity.IndicadorReporteTeorico>();
            indicadorVaquillas = new List<gthEntity.IndicadorReporteTeorico>();

            promedioProduccion = new gthEntity.IndicadorReportePeriodoTyp();
            promedioSecas = new gthEntity.IndicadorReportePeriodoTyp();
            promedioReto = new gthEntity.IndicadorReportePeriodoTyp();
            promedioJaulas = new gthEntity.IndicadorReportePeriodoTyp();
            promedioCrecimiento = new gthEntity.IndicadorReportePeriodoTyp();
            promedioDesarrollo = new gthEntity.IndicadorReportePeriodoTyp();
            promedioVaquillas = new gthEntity.IndicadorReportePeriodoTyp();

            promedioAntProduccion = new gthEntity.IndicadorReportePeriodoTyp();
            promedioAntSecas = new gthEntity.IndicadorReportePeriodoTyp();
            promedioAntReto = new gthEntity.IndicadorReportePeriodoTyp();
            promedioAntJaulas = new gthEntity.IndicadorReportePeriodoTyp();
            promedioAntCrecimiento = new gthEntity.IndicadorReportePeriodoTyp();
            promedioAntDesarrollo = new gthEntity.IndicadorReportePeriodoTyp();
            promedioAntVaquillas = new gthEntity.IndicadorReportePeriodoTyp();
        ...
        public List<gthEntity.IndicadorReporteTeorico> IndicadorProduccion
        {
            get { return indicadorProduccion; }
            set { indicadorProduccion = value; }
        }

        public List<gthEntity.IndicadorReporteTeorico> IndicadorSecas
        {
            get { return indicadorSecas; }
            set { indicadorSecas = value; }
        }

        public List<gthEntity.IndicadorReporteTeorico> IndicadorReto
        {
            get { return indicadorReto; }
            set { indicadorReto = value; }
        }

        public List<gthEntity.IndicadorReporteTeorico> IndicadorCrecimiento
        {
            get { return indicadorCrecimiento; }
            set { indicadorCrecimiento = value; }
        }

        public List<gthEntity.IndicadorReporteTeorico> IndicadorDesarrollo
        {
            get { return indicadorDesarrollo; }
            set { indicadorDesarrollo = value; }
        }

        public List<gthEntity.IndicadorReporteTeorico> IndicadorVaquillas
        {
            get { return indicadorVaquillas; }
            set { indicadorVaquillas = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioProduccion
        {
            get { return promedioProduccion; }
            set { promedioProduccion = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioSecas
        {
            get { return promedioSecas; }
            set { promedioSecas = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioReto
        {
            get { return promedioReto; }
            set { promedioReto = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioJaulas
        {
            get { return promedioJaulas; }
            set { promedioJaulas = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioCrecimiento
        {
            get { return promedioCrecimiento; }
            set { promedioCrecimiento = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioDesarrollo
        {
            get { return promedioDesarrollo; }
            set { promedioDesarrollo = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioVaquillas
        {
            get { return promedioVaquillas; }
            set { promedioVaquillas = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioAntProduccion
        {
            get { return promedioAntProduccion; }
            set { promedioAntProduccion = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioAntSecas
        {
            get { return promedioAntSecas; }
            set { promedioAntSecas = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioAntReto
        {
            get { return promedioAntReto; }
            set { promedioAntReto = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioAntJaulas
        {
        ...
        public gthEntity.IndicadorReportePeriodoTyp PromedioAntCrecimiento
        {
            get { return promedioAntCrecimiento; }
            set { promedioAntCrecimiento = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioAntDesarrollo
        {
            get { return promedioAntDesarrollo; }
            set { promedioAntDesarrollo = value; }
        }

        public gthEntity.IndicadorReportePeriodoTyp PromedioAntVaquillas
        {
        ...
        public decimal PrecioLecheAñoAnt
        {
            get { return precioLecheAñoAnt; }
            set { precioLecheAñoAnt = value; }
        }
        #endregion

        #region Metodos publicos

        public gthEntity.CentroTyp GetCentro()
        {
            return consumoModel.GetCentro();
        }
        ...
        public void CargarDatosTeoricos(gthEntity.CentroTyp centro, DateTime fechaInicio,  DateTime fechaFin, ref string mensaje)
        {
            List<gthEntity.CentroTyp> aux = new List<gthEntity.CentroTyp>();
            aux.Add(centro);

            indicadorProduccion = consumoModel.GetIndicadorReporteTeorico(aux, etapaProduccion, fechaInicio, fechaFin);
            indicadorSecas = consumoModel.GetIndicadorReporteTeorico(aux, etapaSecas, fechaInicio, fechaFin);
            indicadorReto = consumoModel.GetIndicadorReporteTeorico(aux, etapaReto, fechaInicio, fechaFin);
            indicadorCrecimiento = consumoModel.GetIndicadorReporteTeorico(aux, etapaCrecimiento, fechaInicio, fechaFin);
            indicadorDesarrollo = consumoModel.GetIndicadorReporteTeorico(aux, etapaDesarrollo, fechaInicio, fechaFin);
            indicadorVaquillas = consumoModel.GetIndicadorReporteTeorico(aux, etapaVaquillas, fechaInicio, fechaFin);            
        }

        public void CargarPromediosDatosAlimentacion(gthEntity.CentroTyp centro, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            mensaje = string.Empty;
            ...
            try
            {
                ...
                promedioProduccion = consumoModel.GetIndicadorReportePeriodo(aux, etapaProduccion, fechaInicio, fechaFin);
                promedioSecas = consumoModel.GetIndicadorReportePeriodo(aux, etapaSecas, fechaInicio, fechaFin);
                promedioReto = consumoModel.GetIndicadorReportePeriodo(aux, etapaReto, fechaInicio, fechaFin);
                promedioJaulas = consumoModel.GetIndicadorReportePeriodo(aux, etapaJaulas, fechaInicio, fechaFin);
                promedioCrecimiento = consumoModel.GetIndicadorReportePeriodo(aux, etapaCrecimiento, fechaInicio, fechaFin);
                promedioDesarrollo = consumoModel.GetIndicadorReportePeriodo(aux, etapaDesarrollo, fechaInicio, fechaFin);
                promedioVaquillas = consumoModel.GetIndicadorReportePeriodo(aux, etapaVaquillas, fechaInicio, fechaFin);

                promedioAntProduccion = consumoModel.GetIndicadorReportePeriodo(aux, etapaProduccion, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
                promedioAntSecas = consumoModel.GetIndicadorReportePeriodo(aux, etapaSecas, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
                promedioAntReto = consumoModel.GetIndicadorReportePeriodo(aux, etapaReto, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
                promedioAntJaulas = consumoModel.GetIndicadorReportePeriodo(aux, etapaJaulas, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
                promedioAntCrecimiento = consumoModel.GetIndicadorReportePeriodo(aux, etapaCrecimiento, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
                promedioAntDesarrollo = consumoModel.GetIndicadorReportePeriodo(aux, etapaDesarrollo, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
                promedioAntVaquillas = consumoModel.GetIndicadorReportePeriodo(aux, etapaVaquillas, fechaInicio.AddYears(-1), fechaFin.AddYears(-1));
        ...
        public Hoja1 PromedioHoja1(Rancho rancho, gthEntity.IndicadorReportePeriodoTyp indicadorOrdeño, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            ...
            try
            {
                ...
                response.Media = indicadorOrdeño.Media;
                response.Total = promH1.Total;
                response.DEL = promH1.DEL;
                response.ANT = promH1.Ant;

                response.EA = indicadorOrdeño.EficienciaAlimentacion;
                response.ILCA = indicadorOrdeño.ILCAProducccion;
                response.IC = indicadorOrdeño.ICProduccion;
                response.Costo_Litro = indicadorOrdeño.CostoLitro;
                response.MH = indicadorOrdeño.MateriaHumeda;
                response.Porcentaje_MS = (indicadorOrdeño.PorcentajeMS / 100);
                response.MS = indicadorOrdeño.MateriaSeca;
                response.SA = indicadorOrdeño.SobranteAnimal;
                response.MSS = indicadorOrdeño.MateriaSecaSob;
                response.EAS = indicadorOrdeño.EficienciaAlimentacionSob;
                response.Porcentaje_Sob = indicadorOrdeño.MateriaHumeda > 0 ? Convert.ToDecimal(indicadorOrdeño.SobranteAnimal / indicadorOrdeño.MateriaHumeda * 100) : 0;
                response.Costo_Prod = indicadorOrdeño.CostoRacion;
                response.Costo_MS = indicadorOrdeño.CostoMateriaSeca;
        ...
        public void AsignarColorimetriaHoja1(Rancho rancho, List<Hoja1> reporte, List<CalostroYOrdeña> datosCalostro, Hoja1 promedio, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            ...
            try
            {
                ...
                gthEntity.IndicadorReporteTeorico busquedaIndicador = new gthEntity.IndicadorReporteTeorico();
                ...
                foreach (Hoja1 item in reporte)
                {
                    ...
                    item.Color_ILCA = Color1Hoja1(item.ILCA, Convert.ToDecimal(promedioProduccion.ILCAProducccion));
                    item.Color_IC = Color1Hoja1(item.IC, Convert.ToDecimal(promedioProduccion.ICProduccion));
                    item.Color_CostoLitro = Color2Hoja1(item.Costo_Litro, promedio.Costo_Litro);

                    item.Color_MH = ColorDato(item.Ordeño, item.MH, busquedaIndicador.MateriaHumeda);
                    item.Color_PorcentajeMs = ColorDato(item.Ordeño, item.Porcentaje_MS, busquedaIndicador.PorcentajeMs / 100);
                    item.Color_MS = ColorDato(item.Ordeño, item.MS, busquedaIndicador.MateriaSeca);
                    item.Color_CostoProd = ColorDato(item.Ordeño, item.Costo_Prod, busquedaIndicador.Costo);
                    item.Color_CostoMs = ColorDato(item.Ordeño, item.Costo_MS, busquedaIndicador.PrecioKgMs);
        ...
        public Hoja2 PromedioHoja2(gthEntity.CentroTyp centro,Rancho rancho, gthEntity.IndicadorReportePeriodoTyp indicadorOrdeño, gthEntity.IndicadorReportePeriodoTyp indicadorSecas, gthEntity.IndicadorReportePeriodoTyp indicadorReto,
            ...
            gthEntity.IndicadorReportePeriodoTyp indicadorVaquillas, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            ...
            decimal precioLecheX = esPrecioLecheFacturado ? PrecioLecheFacturado(fechaInicio, fechaFin, ref mensaje) : PrecioLecheCalculado(centro.CentroClave, fechaInicio, fechaFin, ref mensaje);
            ...
            try
            {
                ...
                promedio.Jaulas_Inventario = indicadorJaulas.NumeroAnimal;
                promedio.Jaulas_Costo = indicadorJaulas.CostoRacion;

                promedio.Crecimiento_Inventario = indicadorCrecimiento.NumeroAnimal;
                promedio.Crecimiento_MH = indicadorCrecimiento.MateriaHumeda;
                promedio.Crecimiento_MS = indicadorCrecimiento.MateriaSeca;
                promedio.Crecimiento_PorcentajeMS = indicadorCrecimiento.PorcentajeMS;
                promedio.Crecimiento_Costo = indicadorCrecimiento.CostoRacion;
                promedio.Crecimiento_CostoMS = indicadorCrecimiento.CostoMateriaSeca;

                promedio.Desarrollo_Inventario = indicadorDesarrollo.NumeroAnimal;
                promedio.Desarrollo_MH = indicadorDesarrollo.MateriaHumeda;
                promedio.Desarrollo_MS = indicadorDesarrollo.MateriaSeca;
                promedio.Desarrollo_PorcentajeMS = indicadorDesarrollo.PorcentajeMS;
                promedio.Desarrollo_Costo = indicadorDesarrollo.CostoRacion;
                promedio.Desarrollo_CostoMS = indicadorDesarrollo.CostoMateriaSeca;

                promedio.Vaquillas_Inventario = indicadorVaquillas.NumeroAnimal;
                promedio.Vaquillas_MH = indicadorVaquillas.MateriaHumeda;
                promedio.Vaquillas_MS =indicadorVaquillas.MateriaSeca;
                promedio.Vaquillas_PorcentajeMS = indicadorVaquillas.PorcentajeMS;
                promedio.Vaquillas_Costo = indicadorVaquillas.CostoRacion;
                promedio.Vaquillas_CostoMS = indicadorVaquillas.CostoMateriaSeca;

                promedio.Secas_Inventario = indicadorSecas.NumeroAnimal;
                promedio.Secas_MH = indicadorSecas.MateriaHumeda;
                promedio.Secas_PorcentajeMS = indicadorSecas.PorcentajeMS;
                promedio.Secas_MS = indicadorSecas.MateriaSeca;
                promedio.Secas_SA = indicadorSecas.SobranteAnimal;
                promedio.Secas_Mss = indicadorSecas.MateriaSecaSob;
                promedio.Secas_PorcentajeSob = indicadorSecas.MateriaHumeda > 0 ? (indicadorSecas.SobranteAnimal / indicadorSecas.MateriaHumeda * 100) : 0;
                promedio.Secas_Costo = indicadorSecas.CostoRacion;
                promedio.Secas_CostoMS = indicadorSecas.CostoMateriaSeca;

                promedio.Reto_Inventario = indicadorReto.NumeroAnimal;
                promedio.Reto_MH = indicadorReto.MateriaHumeda;
                promedio.Reto_PorcentajeMS = indicadorReto.PorcentajeMS;
                promedio.Reto_MS = indicadorReto.MateriaSeca;
                promedio.Reto_SA = indicadorReto.SobranteAnimal;
                promedio.Reto_Mss = indicadorReto.MateriaSecaSob;
                promedio.Reto_PorcentajeSob = indicadorReto.MateriaHumeda > 0 ? (indicadorReto.SobranteAnimal / indicadorReto.MateriaHumeda * 100) : 0;
                promedio.Reto_Costo = indicadorReto.CostoRacion;
                promedio.Reto_CostoMS = indicadorReto.CostoMateriaSeca;
                ...
                decimal? auxOrdeño = Convert.ToDecimal(indicadorOrdeño.NumeroAnimal * indicadorOrdeño.CostoRacion);
                decimal? auxCosto = (auxJaulas ?? 0) + (auxCrecimiento ?? 0) + (auxDesarrollo ?? 0) + (auxVaquillas ?? 0) + (auxSecas ?? 0) + (auxReto ?? 0) + (auxOrdeño ?? 0);
        ...
        {
            gthEntity.IndicadorReporteTeorico busquedaindicadorCrecimiento = new gthEntity.IndicadorReporteTeorico();
            gthEntity.IndicadorReporteTeorico busquedaindicadorDesarrollo = new gthEntity.IndicadorReporteTeorico();
            gthEntity.IndicadorReporteTeorico busquedaindicadorVaquillas = new gthEntity.IndicadorReporteTeorico();
            gthEntity.IndicadorReporteTeorico busquedaindicadorSecas = new gthEntity.IndicadorReporteTeorico();
            gthEntity.IndicadorReporteTeorico busquedaindicadorReto = new gthEntity.IndicadorReporteTeorico();
            ...
            try
            {
                foreach (Hoja2 item in reporte)
                {
                    ...
                    item.Color_MH_Crecimiento = busquedaindicadorCrecimiento != null ? ColorDato(item.Crecimiento_Inventario, item.Crecimiento_MH, busquedaindicadorCrecimiento.MateriaHumeda) : "";
                    item.Color_MS_Crecimiento = busquedaindicadorCrecimiento != null ? ColorDato(item.Crecimiento_Inventario, item.Crecimiento_MS, busquedaindicadorCrecimiento.MateriaSeca) : "";
                    item.Color_PorcentajeMs_Crecimiento = busquedaindicadorCrecimiento != null ? ColorDato(item.Crecimiento_Inventario, item.Crecimiento_PorcentajeMS, busquedaindicadorCrecimiento.PorcentajeMs) : "";
                    item.Color_CostoMS_Crecimiento = busquedaindicadorCrecimiento != null ? ColorDato(item.Crecimiento_Inventario, item.Crecimiento_CostoMS, busquedaindicadorCrecimiento.PrecioKgMs) : "";
                    ...
                    item.Color_MH_Desarrollo = busquedaindicadorDesarrollo != null ? ColorDato(item.Desarrollo_Inventario, item.Desarrollo_MH, busquedaindicadorDesarrollo.MateriaHumeda) : "";
                    item.Color_MS_Desarrollo = busquedaindicadorDesarrollo != null ? ColorDato(item.Desarrollo_Inventario, item.Desarrollo_MS, busquedaindicadorDesarrollo.MateriaSeca) : "";
                    item.Color_PorcentajeMs_Desarrollo = busquedaindicadorDesarrollo != null ? ColorDato(item.Desarrollo_Inventario, item.Desarrollo_PorcentajeMS, busquedaindicadorDesarrollo.PorcentajeMs) : "";
                    item.Color_CostoMS_Desarrollo = busquedaindicadorDesarrollo != null ? ColorDato(item.Desarrollo_Inventario, item.Desarrollo_CostoMS, busquedaindicadorDesarrollo.PrecioKgMs) : "";
                    ...
                    item.Color_MH_Vaquillas = busquedaindicadorVaquillas != null ? ColorDato(item.Vaquillas_Inventario, item.Vaquillas_MH, busquedaindicadorVaquillas.MateriaHumeda) : "";
                    item.Color_MS_Vaquillas = busquedaindicadorVaquillas != null ? ColorDato(item.Vaquillas_Inventario, item.Vaquillas_MS, busquedaindicadorVaquillas.MateriaSeca) : "";
                    item.Color_PorcentajeMs_Vaquillas = busquedaindicadorVaquillas != null ? ColorDato(item.Vaquillas_Inventario, item.Vaquillas_PorcentajeMS, busquedaindicadorVaquillas.PorcentajeMs) : "";
                    item.Color_CostoMS_Vaquillas = busquedaindicadorVaquillas != null ? ColorDato(item.Vaquillas_Inventario, item.Vaquillas_CostoMS, busquedaindicadorVaquillas.PrecioKgMs) : "";
                    ...
                    item.Color_MH_Secas = busquedaindicadorSecas != null ? ColorDato(item.Secas_Inventario, item.Secas_MH, busquedaindicadorSecas.MateriaHumeda) : "";
                    item.Color_MS_Secas = busquedaindicadorSecas != null ? ColorDato(item.Secas_Inventario, item.Secas_MS, busquedaindicadorSecas.MateriaSeca) : "";
                    item.Color_PorcentajeMs_Secas = busquedaindicadorSecas != null ? ColorDato(item.Secas_Inventario, item.Secas_PorcentajeMS, busquedaindicadorSecas.PorcentajeMs) : "";
                    item.Color_CostoMS_Secas = busquedaindicadorSecas != null ? ColorDato(item.Secas_Inventario, item.Secas_CostoMS, busquedaindicadorSecas.PrecioKgMs) : "";
                    ...
                    item.Color_MH_Reto = busquedaindicadorReto != null ? ColorDato(item.Reto_Inventario, item.Reto_MH, busquedaindicadorReto.MateriaHumeda) : "";
                    item.Color_MS_Reto = busquedaindicadorReto != null ? ColorDato(item.Reto_Inventario, item.Reto_MS, busquedaindicadorReto.MateriaSeca) : "";
                    item.Color_PorcentajeMs_Reto = busquedaindicadorReto != null ? ColorDato(item.Reto_Inventario, item.Reto_PorcentajeMS, busquedaindicadorReto.PorcentajeMs) : "";
                    item.Color_CostoMS_Reto = busquedaindicadorReto != null ? ColorDato(item.Reto_Inventario, item.Reto_CostoMS, busquedaindicadorReto.PrecioKgMs) : "";
        ...
        public void CargarPrecioLeche(gthEntity.CentroTyp centro, Rancho rancho, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            mensaje = string.Empty;
            bool esPrecioFacturado = EsPrecioLecheFacturado(fechaFin);

            precioLeche = esPrecioFacturado ? PrecioLecheFacturado(fechaInicio, fechaFin, ref mensaje) : PrecioLecheCalculado(centro.CentroClave, fechaInicio, fechaFin, ref mensaje);

            DateTime fechaInicioAnt = fechaInicio.AddYears(-1);
            DateTime fechaFinAnt = fechaInicioAnt.AddMonths(1).AddDays(-1);
            precioLecheAñoAnt = PrecioLecheFacturado(fechaInicioAnt, fechaFinAnt, ref mensaje);
        }
        ...
        public void CierreMesCorrecto(int ranId, int horaCorte, string urlWebService, DateTime fechaInicio, DateTime fechaFin, out bool validacionMedicina, out bool validacionAlimento)
        {
            ...
            validacionAlimento = true;
            validacionMedicina = true;
        }
        ...
        public void ValoresConsistentes(gthEntity.CentroTyp centro, Rancho rancho, DateTime fecha)
        {
            try
            {
                ...
                List<gthEntity.CentroTyp> centroAux = new List<gthEntity.CentroTyp>();
                centroAux.Add(centro);

                gthEntity.IndicadorReportePeriodoTyp indicadoresProduccion = new gthEntity.IndicadorReportePeriodoTyp();
                gthEntity.IndicadorReportePeriodoTyp indicadoresSecas = new gthEntity.IndicadorReportePeriodoTyp();
                gthEntity.IndicadorReportePeriodoTyp indicadoresReto = new gthEntity.IndicadorReportePeriodoTyp();
                gthEntity.IndicadorReportePeriodoTyp indicadoresCrecimiento = new gthEntity.IndicadorReportePeriodoTyp();
                gthEntity.IndicadorReportePeriodoTyp indicadoresDesarrollo = new gthEntity.IndicadorReportePeriodoTyp();
                gthEntity.IndicadorReportePeriodoTyp indicadoresVaquillas = new gthEntity.IndicadorReportePeriodoTyp();

                if (evaluacionValConAlim)
                {
                    #region llamado dll Alimentacion
                    indicadoresProduccion = consumoModel.GetIndicadorReportePeriodo(centroAux, etapaProduccion, fechaFinal, fechaFinal);
                    indicadoresSecas = consumoModel.GetIndicadorReportePeriodo(centroAux, etapaSecas, fechaFinal, fechaFinal);
                    indicadoresReto = consumoModel.GetIndicadorReportePeriodo(centroAux, etapaReto, fechaFinal, fechaFinal);
                    indicadoresCrecimiento = consumoModel.GetIndicadorReportePeriodo(centroAux, etapaCrecimiento, fechaFinal, fechaFinal);
                    indicadoresDesarrollo = consumoModel.GetIndicadorReportePeriodo(centroAux, etapaDesarrollo, fechaFinal, fechaFinal);
                    indicadoresVaquillas = consumoModel.GetIndicadorReportePeriodo(centroAux, etapaVaquillas, fechaFinal, fechaFinal);
                    #endregion

                    #region Evaluacion de Ea Producción
                    if (indicadoresProduccion.NumeroAnimal == null || indicadoresProduccion.NumeroAnimal == 0)
                    {
                    ...
                    {
                        valconAlim.EAProd = (indicadoresProduccion.EficienciaAlimentacionSob >= 1.1M && indicadoresProduccion.EficienciaAlimentacionSob <= 1.8M) ? true : false;
                        valconAlim.EAProdValor = indicadoresProduccion.EficienciaAlimentacion;

                        valconAlim.MsProd = (indicadoresProduccion.MateriaSecaSob >= 18 && indicadoresProduccion.MateriaSecaSob <= 32) ? true : false;
                        valconAlim.MsProdValor = indicadoresProduccion.MateriaSecaSob;
                    }
                    #endregion

                    #region Evaluación de MS Destetadas Uno
                    if (indicadoresCrecimiento.NumeroAnimal == null || indicadoresCrecimiento.NumeroAnimal == 0)
                    {
                    ...
                    {
                        valconAlim.MsCrecimiento = (indicadoresCrecimiento.MateriaSecaSob >= 2 && indicadoresCrecimiento.MateriaSecaSob <= 8) ? true : false;
                        valconAlim.MsCrecimientosValor = indicadoresCrecimiento.MateriaSecaSob;
                    }
                    #endregion

                    #region Evaluación de Ms Destete Dos
                    if (indicadoresDesarrollo.NumeroAnimal == 0)
                    {
                    ...
                    {
                        valconAlim.MsDesarollo = (indicadoresDesarrollo.MateriaSecaSob >= 6 && indicadoresDesarrollo.MateriaSecaSob <= 11) ? true : false;
                        valconAlim.MsDesarolloValor = indicadoresDesarrollo.MateriaSecaSob;
                    }
                    #endregion

                    #region Evaluación de Ms Vaquillas
                    if (indicadoresVaquillas.NumeroAnimal == 0)
                    {
                    ...
                    {
                        valconAlim.MsVaquillas = (indicadoresVaquillas.MateriaSecaSob >= 8 && indicadoresVaquillas.MateriaSecaSob <= 15) ? true : false;
                        valconAlim.MsVaquillasValor = indicadoresVaquillas.MateriaSecaSob;
                    }
                    #endregion

                    #region Evaluación de MS Secas
                    if (indicadoresSecas.NumeroAnimal == 0)
                    {
                    ...
                    {
                        valconAlim.MsSecas = (indicadoresSecas.MateriaSecaSob >= 10 && indicadoresSecas.MateriaSecaSob <= 19) ? true : false;
                        valconAlim.MsSecasValor = indicadoresSecas.MateriaSecaSob;
                    }
                    #endregion

                    #region Evaluación de MS Reto
                    if (indicadoresReto.NumeroAnimal == 0)
                    {
                    ...
                    {
                        valconAlim.MsReto = (indicadoresReto.MateriaSecaSob >= 9 && indicadoresReto.MateriaSecaSob <= 19) ? true : false;
                        valconAlim.MsRetoValor = indicadoresReto.MateriaSecaSob;
                ...
                for (int i = 0; i < 36; i++)
                {
                    ...
                    indicadorValConAlim.EAProdValor = infoValConAlimPerido.EA;
                    indicadorValConAlim.MsProdValor = infoValConAlimPerido.Produccion;
                    indicadorValConAlim.MsCrecimientosValor = infoValConAlimPerido.Crecimiento;
                    indicadorValConAlim.MsDesarolloValor = infoValConAlimPerido.Desarrollo;
                    indicadorValConAlim.MsVaquillasValor = infoValConAlimPerido.Vaquillas;
                    indicadorValConAlim.MsSecasValor = infoValConAlimPerido.Secas;
                    indicadorValConAlim.MsRetoValor = infoValConAlimPerido.Reto;
                    #endregion
            ...
            try
            {
                ...
                if (fechaInicio.Year == mesAnt.Year && fechaInicio.Month == mesAnt.Month && fechaFin.Month == mesAnt.Month && fechaFin.Year == mesAnt.Year && hoy.Day < 7)
                {
                    query = @"WITH FechaPrecioLeche AS
                            (
                                SELECT Centro, MAX(Fecha) AS Fecha
                                FROM DBCONSUMO.dbo.PrecioLecheTbl
                                WHERE Centro = @rancho
                                AND CONVERT(int, FORMAT(Fecha, 'yyyyMM')) = @fecha
                                GROUP BY Centro
                            )
                            select p.PrecioLeche AS Precio_Leche
                            FROM DBCONSUMO.dbo.PrecioLecheTbl p 
                            INNER JOIN FechaPrecioLeche fpl ON p.Centro = fpl.Centro AND p.Fecha = fpl.Fecha";
