...
namespace ReportePeriodo.Presentador
{
    public class Presenter
    {
        ...
        {
            _model.CargarDatosTeoricos(centro, fechaInicio, fechaFin, ref mensaje);
        }
        ...
        {
            _model.CargarPromediosDatosAlimentacion(centro, fechaInicio, fechaFin, ref mensaje);
        }

        public List<Hoja2> ReporteHoja2(CentroTyp centro, Rancho rancho, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            mensaje = string.Empty;
            List<Hoja2> response = _model.ReporteHoja2(rancho, fechaInicio, fechaFin, ref mensaje);
            Hoja2 promedio = _model.PromedioHoja2(centro, rancho, _model.PromedioProduccion, _model.PromedioSecas, _model.PromedioReto, _model.PromedioJaulas, _model.PromedioCrecimiento, _model.PromedioDesarrollo, _model.PromedioVaquillas, fechaInicio, fechaFin, ref mensaje);
            promedio.Dia = "PROM";
            Hoja2 promedioAñoAnt = _model.PromedioHoja2(centro, rancho, _model.PromedioAntProduccion, _model.PromedioAntSecas, _model.PromedioAntReto, _model.PromedioAntJaulas, _model.PromedioAntCrecimiento, _model.PromedioAntDesarrollo, _model.PromedioAntVaquillas, fechaInicio.AddYears(-1), fechaFin.AddYears(-1), ref mensaje);
            promedioAñoAnt.Dia = "AÑO ANT";
        ...
        {
            get { return _model.PrecioLecheAñoAnt; }
            set { _model.PrecioLecheAñoAnt = value; }
        }

        public void CargarPrecioLeche(CentroTyp centro, Rancho rancho, DateTime fechaInicio, DateTime fechaFin, ref string mensaje)
        {
            _model.CargarPrecioLeche(centro, rancho, fechaInicio, fechaFin, ref mensaje);
        }
        ...
        {
            _model.ValoresConsistentes(centro, rancho, fecha);
        }
    }
}
